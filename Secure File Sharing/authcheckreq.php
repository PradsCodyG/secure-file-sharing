...
<body>
   <div class="loginbox">
   <h1>AUTHORITY FILE SECRET KEY</h1>
	<table bgcolor="#ff9ff3" width="90%" cellpadding="0" cellspacing="0" align="center">
	    <tr>
		   ...
		   <td><font color="black">SECRET KEY</font></td>
		...
		if($result-> num_rows > 0){
		   while($row = $result-> fetch_assoc()){
		     echo "<td>".$row["name"]."</td><td>".$row["upload"]."</td><td>".$row["fsize"]."</td><td>".$row["stat"]."</td>";}
		...
		if($result-> num_rows > 0){
		   ...
		   <td><font color="white"><a href="authcheckreq2.php">SEND KEY</a></font></td>
